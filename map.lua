...
local function Tracking_Update()
	...
	--[[
		...
		MiniMapTrackingButton:SetNormalTexture(addon._dir..'ui-hud-minimap-tracking-up');
		MiniMapTrackingButton:SetPushedTexture(addon._dir..'ui-hud-minimap-tracking-down');
