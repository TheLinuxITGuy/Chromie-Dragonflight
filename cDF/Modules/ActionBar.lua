...
local function ReplaceBlizzardBagsBarFrame(frameBar)
    ...
    if cDFDB and cDFDB.bagsExpanded then
    ...
    toggleButton:SetScript("OnClick", function(self)
        ...
        cDFDB.bagsExpanded = not self.toggle
...
function Module:LoadDefaultSettings()
    cDF.DB.profile.widgets.actionBar = {}

    for index = 1, 3 do
        cDF.DB.profile.widgets['actionBar' .. index] = {
            anchor = "BOTTOM",
            posX = 0,
            posY = 60 + 4 * (index - 1) +
                42 * (index - 1)
    ...
    cDF.DB.profile.widgets['actionBar' .. SHAPESHIFT_ACTION_BAR_ID] = {
        anchor = "BOTTOM",
        posX = -94,
        posY = 200
    }

    cDF.DB.profile.widgets.microMenuBar = { anchor = "BOTTOMRIGHT", posX = 50, posY = 10 }
    cDF.DB.profile.widgets.bagsBar = { anchor = "BOTTOMRIGHT", posX = 13, posY = 45 }
    cDF.DB.profile.widgets.repExpBar = { anchor = "BOTTOM", posX = 0, posY = 35 }

    -- Static
    cDF.DB.profile.widgets['actionBar' .. PET_ACTION_BAR_ID] = {
        anchor = "CENTER",
        posX = 0,
        posY = 0
    }

    cDF.DB.profile.widgets['actionBar' .. BONUS_ACTION_BAR_ID] = {
        anchor = "CENTER",
        posX = 0,
        posY = 0
    }

    cDF.DB.profile.widgets['actionBar' .. POSSESS_ACTION_BAR_ID] = {
        anchor = "CENTER",
        posX = 0,
        posY = 0
    }

    cDF.DB.profile.widgets['actionBar' .. VEHICLE_ACTION_BAR_ID] = {
        anchor = "CENTER",
        posX = 0,
        posY = 0
    }

    cDF.DB.profile.widgets['actionBar' .. MULTICAST_ACTION_BAR_ID] = {
        anchor = "CENTER",
        posX = 0,
        posY = 0
    }
